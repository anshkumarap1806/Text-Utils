        ...
        export default function About() {
            ...
            const[btext,bttext]=useState("Enable Dark Mode")
            const tstyle=()=>{
            ...
            <div className="accordion-item">
                ...
                <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" style={style} data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
            ...
            <div className="container">
                <button type="button" onClick={tstyle} class="btn btn-primary my-3">{btext}</button>
            </div>
            </>
            )
    }
